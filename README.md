...
* **Criação e Edição:** Ferramentas intuitivas para desenhar e ajustar polígonos no mapa.
* **Exportação:** Geração de arquivos **.KML** e **.KMZ**.
* **Integração WhatsApp:** Envio direto dos arquivos para a equipe da ENGESAT, acelerando o processo de orçamento e viabilidade.
* **Importação Versátil:**
